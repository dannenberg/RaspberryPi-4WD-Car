...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/bigquery/storage/v1/protobuf.proto',
...
_PROTOSCHEMA = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='proto_descriptor', full_name='google.cloud.bigquery.storage.v1.ProtoSchema.proto_descriptor', index=0,
...
_PROTOROWS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='serialized_rows', full_name='google.cloud.bigquery.storage.v1.ProtoRows.serialized_rows', index=0,
