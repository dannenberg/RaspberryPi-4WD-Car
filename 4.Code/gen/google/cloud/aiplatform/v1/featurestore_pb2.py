...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/aiplatform/v1/featurestore.proto',
...
_FEATURESTORE_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='google.cloud.aiplatform.v1.Featurestore.State',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_FEATURESTORE_ONLINESERVINGCONFIG = _descriptor.Descriptor(
  ...
  full_name='google.cloud.aiplatform.v1.Featurestore.OnlineServingConfig',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='fixed_node_count', full_name='google.cloud.aiplatform.v1.Featurestore.OnlineServingConfig.fixed_node_count', index=0,
...
_FEATURESTORE_LABELSENTRY = _descriptor.Descriptor(
  name='LabelsEntry',
  full_name='google.cloud.aiplatform.v1.Featurestore.LabelsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.aiplatform.v1.Featurestore.LabelsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.aiplatform.v1.Featurestore.LabelsEntry.value', index=1,
...
_FEATURESTORE = _descriptor.Descriptor(
  name='Featurestore',
  full_name='google.cloud.aiplatform.v1.Featurestore',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.aiplatform.v1.Featurestore.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.aiplatform.v1.Featurestore.create_time', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.cloud.aiplatform.v1.Featurestore.update_time', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='etag', full_name='google.cloud.aiplatform.v1.Featurestore.etag', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='labels', full_name='google.cloud.aiplatform.v1.Featurestore.labels', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='online_serving_config', full_name='google.cloud.aiplatform.v1.Featurestore.online_serving_config', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.aiplatform.v1.Featurestore.state', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='encryption_spec', full_name='google.cloud.aiplatform.v1.Featurestore.encryption_spec', index=7,
...
_FEATURESTORE.fields_by_name['encryption_spec'].message_type = google_dot_cloud_dot_aiplatform_dot_v1_dot_encryption__spec__pb2._ENCRYPTIONSPEC
