...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/aiplatform/v1/tensorboard_run.proto',
...
_TENSORBOARDRUN_LABELSENTRY = _descriptor.Descriptor(
  name='LabelsEntry',
  full_name='google.cloud.aiplatform.v1.TensorboardRun.LabelsEntry',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='google.cloud.aiplatform.v1.TensorboardRun.LabelsEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='google.cloud.aiplatform.v1.TensorboardRun.LabelsEntry.value', index=1,
...
_TENSORBOARDRUN = _descriptor.Descriptor(
  name='TensorboardRun',
  full_name='google.cloud.aiplatform.v1.TensorboardRun',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.aiplatform.v1.TensorboardRun.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='display_name', full_name='google.cloud.aiplatform.v1.TensorboardRun.display_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='description', full_name='google.cloud.aiplatform.v1.TensorboardRun.description', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='create_time', full_name='google.cloud.aiplatform.v1.TensorboardRun.create_time', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='update_time', full_name='google.cloud.aiplatform.v1.TensorboardRun.update_time', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='labels', full_name='google.cloud.aiplatform.v1.TensorboardRun.labels', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='etag', full_name='google.cloud.aiplatform.v1.TensorboardRun.etag', index=6,
