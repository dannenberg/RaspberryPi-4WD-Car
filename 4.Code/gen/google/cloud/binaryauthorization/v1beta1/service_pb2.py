...
_GETSYSTEMPOLICYREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.binaryauthorization.v1beta1.GetSystemPolicyRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.binaryauthorization.v1beta1.GetSystemPolicyRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_BINAUTHZMANAGEMENTSERVICEV1BETA1 = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\332A\004name\202\323\344\223\002#\022!/v1beta1/{name=projects/*/policy}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='UpdatePolicy',
    ...
    output_type=google_dot_cloud_dot_binaryauthorization_dot_v1beta1_dot_resources__pb2._POLICY,
    serialized_options=b'\332A\006policy\202\323\344\223\0022\032(/v1beta1/{policy.name=projects/*/policy}:\006policy',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='CreateAttestor',
    ...
    serialized_options=b'\332A\033parent,attestor_id,attestor\202\323\344\223\0022\"&/v1beta1/{parent=projects/*}/attestors:\010attestor',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetAttestor',
    ...
    output_type=google_dot_cloud_dot_binaryauthorization_dot_v1beta1_dot_resources__pb2._ATTESTOR,
    serialized_options=b'\332A\004name\202\323\344\223\002(\022&/v1beta1/{name=projects/*/attestors/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='UpdateAttestor',
    ...
    output_type=google_dot_cloud_dot_binaryauthorization_dot_v1beta1_dot_resources__pb2._ATTESTOR,
    serialized_options=b'\332A\010attestor\202\323\344\223\002;\032//v1beta1/{attestor.name=projects/*/attestors/*}:\010attestor',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='ListAttestors',
    ...
    serialized_options=b'\332A\006parent\202\323\344\223\002(\022&/v1beta1/{parent=projects/*}/attestors',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='DeleteAttestor',
    ...
    serialized_options=b'\332A\004name\202\323\344\223\002(*&/v1beta1/{name=projects/*/attestors/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
...
_SYSTEMPOLICYV1BETA1 = _descriptor.ServiceDescriptor(
  name='SystemPolicyV1Beta1',
  full_name='google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1',
  file=DESCRIPTOR,
  index=1,
  serialized_options=b'\312A\"binaryauthorization.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platform',
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.cloud.binaryauthorization.v1beta1.SystemPolicyV1Beta1.GetSystemPolicy',
    index=0,
    containing_service=None,
    input_type=_GETSYSTEMPOLICYREQUEST,
    output_type=google_dot_cloud_dot_binaryauthorization_dot_v1beta1_dot_resources__pb2._POLICY,
    serialized_options=b'\332A\004name\202\323\344\223\002$\022\"/v1beta1/{name=locations/*/policy}',
    create_key=_descriptor._internal_create_key,
  ),
])
_sym_db.RegisterServiceDescriptor(_SYSTEMPOLICYV1BETA1)

DESCRIPTOR.services_by_name['SystemPolicyV1Beta1'] = _SYSTEMPOLICYV1BETA1
