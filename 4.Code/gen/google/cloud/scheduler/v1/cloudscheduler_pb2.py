...
_LISTJOBSREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\342A\001\002\372A#\022!cloudscheduler.googleapis.com/Job', json_name='parent', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
_GETJOBREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A#\n!cloudscheduler.googleapis.com/Job', json_name='name', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_CLOUDSCHEDULER = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB,
    serialized_options=b'\332A\017job,update_mask\202\323\344\223\00232,/v1/{job.name=projects/*/locations/*/jobs/*}:\003job',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='DeleteJob',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB,
    serialized_options=b'\332A\004name\202\323\344\223\0023\"./v1/{name=projects/*/locations/*/jobs/*}:pause:\001*',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='ResumeJob',
    ...
    output_type=google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB,
    serialized_options=b'\332A\004name\202\323\344\223\0024\"//v1/{name=projects/*/locations/*/jobs/*}:resume:\001*',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='RunJob',
    ...
    output_type=google_dot_cloud_dot_scheduler_dot_v1_dot_job__pb2._JOB,
    serialized_options=b'\332A\004name\202\323\344\223\0021\",/v1/{name=projects/*/locations/*/jobs/*}:run:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
