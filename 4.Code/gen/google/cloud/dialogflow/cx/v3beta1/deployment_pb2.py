...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/cloud/dialogflow/cx/v3beta1/deployment.proto',
...
_DEPLOYMENT_STATE = _descriptor.EnumDescriptor(
  name='State',
  full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.State',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
...
_DEPLOYMENT_RESULT = _descriptor.Descriptor(
  name='Result',
  full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.Result',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='deployment_test_results', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.Result.deployment_test_results', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='experiment', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.Result.experiment', index=1,
...
_DEPLOYMENT = _descriptor.Descriptor(
  name='Deployment',
  full_name='google.cloud.dialogflow.cx.v3beta1.Deployment',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='flow_version', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.flow_version', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='state', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.state', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='result', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.result', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='start_time', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.start_time', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='end_time', full_name='google.cloud.dialogflow.cx.v3beta1.Deployment.end_time', index=5,
...
_LISTDEPLOYMENTSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsRequest.parent', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='page_size', full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsRequest.page_size', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='page_token', full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsRequest.page_token', index=2,
...
_LISTDEPLOYMENTSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='deployments', full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsResponse.deployments', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='next_page_token', full_name='google.cloud.dialogflow.cx.v3beta1.ListDeploymentsResponse.next_page_token', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETDEPLOYMENTREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.cloud.dialogflow.cx.v3beta1.GetDeploymentRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.cloud.dialogflow.cx.v3beta1.GetDeploymentRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEPLOYMENTS = _descriptor.ServiceDescriptor(
  name='Deployments',
  full_name='google.cloud.dialogflow.cx.v3beta1.Deployments',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.cloud.dialogflow.cx.v3beta1.Deployments.ListDeployments',
    index=0,
    containing_service=None,
    input_type=_LISTDEPLOYMENTSREQUEST,
    output_type=_LISTDEPLOYMENTSRESPONSE,
    serialized_options=b'\332A\006parent\202\323\344\223\002N\022L/v3beta1/{parent=projects/*/locations/*/agents/*/environments/*}/deployments',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetDeployment',
    full_name='google.cloud.dialogflow.cx.v3beta1.Deployments.GetDeployment',
    index=1,
    containing_service=None,
    input_type=_GETDEPLOYMENTREQUEST,
    output_type=_DEPLOYMENT,
    serialized_options=b'\332A\004name\202\323\344\223\002N\022L/v3beta1/{name=projects/*/locations/*/agents/*/environments/*/deployments/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
