...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/example/showcase/v1beta3/sequence.proto',
  package='google.example.showcase.v1beta3',
  syntax='proto3',
  serialized_options=b'\n#com.google.example.showcase.v1beta3B\rSequenceProtoP\001Z4github.com/googleapis/gapic-showcase/server/genproto\352\002\031Google::Showcase::V1beta3',
  create_key=_descriptor._internal_create_key,
  serialized_pb=b'\n.google/example/showcase/v1beta3/sequence.proto\x12\x1fgoogle.example.showcase.v1beta3\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x19google/api/resource.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x17google/rpc/status.proto\"\x9c\x02\n\x08Sequence\x12\x18\n\x04name\x18\x01 \x01(\tB\x04\xe2\x41\x01\x03R\x04name\x12P\n\tresponses\x18\x02 \x03(\x0b\x32\x32.google.example.showcase.v1beta3.Sequence.ResponseR\tresponses\x1ag\n\x08Response\x12*\n\x06status\x18\x01 \x01(\x0b\x32\x12.google.rpc.StatusR\x06status\x12/\n\x05\x64\x65lay\x18\x02 \x01(\x0b\x32\x19.google.protobuf.DurationR\x05\x64\x65lay:;\xea\x41\x38\n showcase.googleapis.com/Sequence\x12\x14sequences/{sequence}\"\xf8\x03\n\x0eSequenceReport\x12\x18\n\x04name\x18\x01 \x01(\tB\x04\xe2\x41\x01\x03R\x04name\x12S\n\x08\x61ttempts\x18\x02 \x03(\x0b\x32\x37.google.example.showcase.v1beta3.SequenceReport.AttemptR\x08\x61ttempts\x1a\xa4\x02\n\x07\x41ttempt\x12%\n\x0e\x61ttempt_number\x18\x01 \x01(\x05R\rattemptNumber\x12\x45\n\x10\x61ttempt_deadline\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.TimestampR\x0f\x61ttemptDeadline\x12?\n\rresponse_time\x18\x03 \x01(\x0b\x32\x1a.google.protobuf.TimestampR\x0cresponseTime\x12>\n\rattempt_delay\x18\x04 \x01(\x0b\x32\x19.google.protobuf.DurationR\x0c\x61ttemptDelay\x12*\n\x06status\x18\x05 \x01(\x0b\x32\x12.google.rpc.StatusR\x06status:P\xea\x41M\n&showcase.googleapis.com/SequenceReport\x12#sequences/{sequence}/sequenceReport\"^\n\x15\x43reateSequenceRequest\x12\x45\n\x08sequence\x18\x01 \x01(\x0b\x32).google.example.showcase.v1beta3.SequenceR\x08sequence\"W\n\x16\x41ttemptSequenceRequest\x12=\n\x04name\x18\x01 \x01(\tB)\xe2\x41\x01\x02\xfa\x41\"\n showcase.googleapis.com/SequenceR\x04name\"_\n\x18GetSequenceReportRequest\x12\x43\n\x04name\x18\x01 \x01(\tB/\xe2\x41\x01\x02\xfa\x41(\n&showcase.googleapis.com/SequenceReportR\x04name2\xa5\x04\n\x0fSequenceService\x12\xa4\x01\n\x0e\x43reateSequence\x12\x36.google.example.showcase.v1beta3.CreateSequenceRequest\x1a).google.example.showcase.v1beta3.Sequence\"/\xda\x41\x08sequence\x82\xd3\xe4\x93\x02\x1e\"\x12/v1beta3/sequences:\x08sequence\x12\xba\x01\n\x11GetSequenceReport\x12\x39.google.example.showcase.v1beta3.GetSequenceReportRequest\x1a/.google.example.showcase.v1beta3.SequenceReport\"9\xda\x41\x04name\x82\xd3\xe4\x93\x02,\x12*/v1beta3/{name=sequences/*/sequenceReport}\x12\x91\x01\n\x0f\x41ttemptSequence\x12\x37.google.example.showcase.v1beta3.AttemptSequenceRequest\x1a\x16.google.protobuf.Empty\"-\xda\x41\x04name\x82\xd3\xe4\x93\x02 \"\x1b/v1beta3/{name=sequences/*}:\x01*\x1a\x1a\xca\x41\x17showcase.googleapis.comB\x88\x01\n#com.google.example.showcase.v1beta3B\rSequenceProtoP\x01Z4github.com/googleapis/gapic-showcase/server/genproto\xea\x02\x19Google::Showcase::V1beta3b\x06proto3'
  ,
...
_SEQUENCE_RESPONSE = _descriptor.Descriptor(
  name='Response',
  full_name='google.example.showcase.v1beta3.Sequence.Response',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='status', full_name='google.example.showcase.v1beta3.Sequence.Response.status', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='delay', full_name='google.example.showcase.v1beta3.Sequence.Response.delay', index=1,
...
_SEQUENCE = _descriptor.Descriptor(
  name='Sequence',
  full_name='google.example.showcase.v1beta3.Sequence',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.example.showcase.v1beta3.Sequence.name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='responses', full_name='google.example.showcase.v1beta3.Sequence.responses', index=1,
...
_SEQUENCEREPORT_ATTEMPT = _descriptor.Descriptor(
  name='Attempt',
  full_name='google.example.showcase.v1beta3.SequenceReport.Attempt',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='attempt_number', full_name='google.example.showcase.v1beta3.SequenceReport.Attempt.attempt_number', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='attempt_deadline', full_name='google.example.showcase.v1beta3.SequenceReport.Attempt.attempt_deadline', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='response_time', full_name='google.example.showcase.v1beta3.SequenceReport.Attempt.response_time', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='attempt_delay', full_name='google.example.showcase.v1beta3.SequenceReport.Attempt.attempt_delay', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.example.showcase.v1beta3.SequenceReport.Attempt.status', index=4,
...
_SEQUENCEREPORT = _descriptor.Descriptor(
  name='SequenceReport',
  full_name='google.example.showcase.v1beta3.SequenceReport',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.example.showcase.v1beta3.SequenceReport.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\003', json_name='name', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='attempts', full_name='google.example.showcase.v1beta3.SequenceReport.attempts', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATESEQUENCEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.example.showcase.v1beta3.CreateSequenceRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='sequence', full_name='google.example.showcase.v1beta3.CreateSequenceRequest.sequence', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ATTEMPTSEQUENCEREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.example.showcase.v1beta3.AttemptSequenceRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.example.showcase.v1beta3.AttemptSequenceRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_GETSEQUENCEREPORTREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.example.showcase.v1beta3.GetSequenceReportRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='google.example.showcase.v1beta3.GetSequenceReportRequest.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Sequence = _reflection.GeneratedProtocolMessageType('Sequence', (_message.Message,), {
  ...
  'Response' : _reflection.GeneratedProtocolMessageType('Response', (_message.Message,), {
    ...
    '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
    # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.Sequence.Response)
    })
  ,
  'DESCRIPTOR' : _SEQUENCE,
  '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
  # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.Sequence)
  })
...
SequenceReport = _reflection.GeneratedProtocolMessageType('SequenceReport', (_message.Message,), {
  ...
  'Attempt' : _reflection.GeneratedProtocolMessageType('Attempt', (_message.Message,), {
    ...
    '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
    # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.SequenceReport.Attempt)
    })
  ,
  'DESCRIPTOR' : _SEQUENCEREPORT,
  '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
  # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.SequenceReport)
  })
...
CreateSequenceRequest = _reflection.GeneratedProtocolMessageType('CreateSequenceRequest', (_message.Message,), {
  ...
  '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
  # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.CreateSequenceRequest)
  })
...
AttemptSequenceRequest = _reflection.GeneratedProtocolMessageType('AttemptSequenceRequest', (_message.Message,), {
  ...
  '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
  # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.AttemptSequenceRequest)
  })
...
GetSequenceReportRequest = _reflection.GeneratedProtocolMessageType('GetSequenceReportRequest', (_message.Message,), {
  ...
  '__module__' : 'google.example.showcase.v1beta3.sequence_pb2'
  # @@protoc_insertion_point(class_scope:google.example.showcase.v1beta3.GetSequenceReportRequest)
  })
...
_SEQUENCESERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.example.showcase.v1beta3.SequenceService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='CreateSequence',
    full_name='google.example.showcase.v1beta3.SequenceService.CreateSequence',
    index=0,
    containing_service=None,
    input_type=_CREATESEQUENCEREQUEST,
    output_type=_SEQUENCE,
    serialized_options=b'\332A\010sequence\202\323\344\223\002\036\"\022/v1beta3/sequences:\010sequence',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetSequenceReport',
    full_name='google.example.showcase.v1beta3.SequenceService.GetSequenceReport',
    index=1,
    containing_service=None,
    input_type=_GETSEQUENCEREPORTREQUEST,
    output_type=_SEQUENCEREPORT,
    serialized_options=b'\332A\004name\202\323\344\223\002,\022*/v1beta3/{name=sequences/*/sequenceReport}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='AttemptSequence',
    full_name='google.example.showcase.v1beta3.SequenceService.AttemptSequence',
    index=2,
    containing_service=None,
    input_type=_ATTEMPTSEQUENCEREQUEST,
    output_type=google_dot_protobuf_dot_empty__pb2._EMPTY,
    serialized_options=b'\332A\004name\202\323\344\223\002 \"\033/v1beta3/{name=sequences/*}:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
