...
_CREATEALERTPOLICYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\342A\001\002\372A\'\022%monitoring.googleapis.com/AlertPolicy', json_name='name', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002', json_name='alertPolicy', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_GETALERTPOLICYREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A\'\n%monitoring.googleapis.com/AlertPolicy', json_name='name', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LISTALERTPOLICIESRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='alertPolicies', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
...
_ALERTPOLICYSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\332A\004name\202\323\344\223\002%\022#/v3/{name=projects/*}/alertPolicies',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='GetAlertPolicy',
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_monitoring_dot_v3_dot_alert__pb2._ALERTPOLICY,
    serialized_options=b'\332A\021name,alert_policy\202\323\344\223\0023\"#/v3/{name=projects/*}/alertPolicies:\014alert_policy',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\332A\004name\202\323\344\223\002\'*%/v3/{name=projects/*/alertPolicies/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=google_dot_monitoring_dot_v3_dot_alert__pb2._ALERTPOLICY,
    serialized_options=b'\332A\030update_mask,alert_policy\202\323\344\223\002B22/v3/{alert_policy.name=projects/*/alertPolicies/*}:\014alert_policy',
    create_key=_descriptor._internal_create_key,
  ),
])
