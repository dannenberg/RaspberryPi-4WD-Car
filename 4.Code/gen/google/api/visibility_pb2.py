...
enum_visibility = _descriptor.FieldDescriptor(
  ...
  serialized_options=None, json_name='enumVisibility', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
value_visibility = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='valueVisibility', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
field_visibility = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='fieldVisibility', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
message_visibility = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='messageVisibility', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
api_visibility = _descriptor.FieldDescriptor(
  ...
  message_type=None, enum_type=None, containing_type=None,
  is_extension=True, extension_scope=None,
  serialized_options=None, json_name='apiVisibility', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
...
_VISIBILITYRULE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='restriction', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
