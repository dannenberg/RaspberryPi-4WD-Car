...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n+google/devtools/build/v1/build_status.proto\x12\x18google.devtools.build.v1\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x19google/protobuf/any.proto\"\xd5\x03\n\x0b\x42uildStatus\x12\x44\n\x06result\x18\x01 \x01(\x0e\x32,.google.devtools.build.v1.BuildStatus.ResultR\x06result\x12.\n\x13\x66inal_invocation_id\x18\x03 \x01(\tR\x11\x66inalInvocationId\x12L\n\x14\x62uild_tool_exit_code\x18\x04 \x01(\x0b\x32\x1b.google.protobuf.Int32ValueR\x11\x62uildToolExitCode\x12.\n\x07\x64\x65tails\x18\x02 \x01(\x0b\x32\x14.google.protobuf.AnyR\x07\x64\x65tails\"\xd1\x01\n\x06Result\x12\x12\n\x0eUNKNOWN_STATUS\x10\x00\x12\x15\n\x11\x43OMMAND_SUCCEEDED\x10\x01\x12\x12\n\x0e\x43OMMAND_FAILED\x10\x02\x12\x0e\n\nUSER_ERROR\x10\x03\x12\x10\n\x0cSYSTEM_ERROR\x10\x04\x12\x16\n\x12RESOURCE_EXHAUSTED\x10\x05\x12 \n\x1cINVOCATION_DEADLINE_EXCEEDED\x10\x06\x12\x1d\n\x19REQUEST_DEADLINE_EXCEEDED\x10\x08\x12\r\n\tCANCELLED\x10\x07\x42\x8c\x01\n\x1c\x63om.google.devtools.build.v1B\x10\x42uildStatusProtoP\x01Z=google.golang.org/genproto/googleapis/devtools/build/v1;build\xf8\x01\x01\xca\x02\x15Google\\Cloud\\Build\\V1b\x06proto3'
  ,
...
_BUILDSTATUS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='finalInvocationId', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='buildToolExitCode', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
