...
_CONVERSIONADJUSTMENTUPLOADSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\332A2customer_id,conversion_adjustments,partial_failure\202\323\344\223\002>\"9/v8/customers/{customer_id=*}:uploadConversionAdjustments:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
