...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/common/tag_snippet.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_tracking__code__page__format__pb2.DESCRIPTOR,google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_tracking__code__type__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_TAGSNIPPET = _descriptor.Descriptor(
  name='TagSnippet',
  full_name='google.ads.googleads.v9.common.TagSnippet',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v9.common.TagSnippet.type', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='page_format', full_name='google.ads.googleads.v9.common.TagSnippet.page_format', index=1,
      number=2, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='pageFormat', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='global_site_tag', full_name='google.ads.googleads.v9.common.TagSnippet.global_site_tag', index=2,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='globalSiteTag', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='event_snippet', full_name='google.ads.googleads.v9.common.TagSnippet.event_snippet', index=3,
      number=6, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='eventSnippet', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_global_site_tag', full_name='google.ads.googleads.v9.common.TagSnippet._global_site_tag',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_event_snippet', full_name='google.ads.googleads.v9.common.TagSnippet._event_snippet',
...
_TAGSNIPPET.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_tracking__code__type__pb2._TRACKINGCODETYPEENUM_TRACKINGCODETYPE
_TAGSNIPPET.fields_by_name['page_format'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_tracking__code__page__format__pb2._TRACKINGCODEPAGEFORMATENUM_TRACKINGCODEPAGEFORMAT
