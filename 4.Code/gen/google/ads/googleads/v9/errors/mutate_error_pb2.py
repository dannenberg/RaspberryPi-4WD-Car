...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/errors/mutate_error.proto',
...
_MUTATEERRORENUM_MUTATEERROR = _descriptor.EnumDescriptor(
  name='MutateError',
  full_name='google.ads.googleads.v9.errors.MutateErrorEnum.MutateError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='OPERATION_DOES_NOT_SUPPORT_PARTIAL_FAILURE', index=9, number=16,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='RESOURCE_READ_ONLY', index=10, number=13,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_MUTATEERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.errors.MutateErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
