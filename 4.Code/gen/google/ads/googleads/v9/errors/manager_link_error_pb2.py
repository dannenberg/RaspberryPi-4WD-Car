...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/errors/manager_link_error.proto',
...
_MANAGERLINKERRORENUM_MANAGERLINKERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v9.errors.ManagerLinkErrorEnum.ManagerLinkError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CUSTOMER_CANNOT_MANAGE_SELF', index=19, number=19,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CREATING_ENABLED_LINK_NOT_ALLOWED', index=20, number=20,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_MANAGERLINKERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.errors.ManagerLinkErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
ManagerLinkErrorEnum = _reflection.GeneratedProtocolMessageType('ManagerLinkErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.errors.manager_link_error_pb2'
