...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/errors/campaign_error.proto',
...
_CAMPAIGNERRORENUM_CAMPAIGNERROR = _descriptor.EnumDescriptor(
  name='CampaignError',
  full_name='google.ads.googleads.v9.errors.CampaignErrorEnum.CampaignError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='CANNOT_CREATE_APP_PRE_REGISTRATION_FOR_NON_ANDROID_APP', index=45, number=50,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='APP_NOT_AVAILABLE_TO_CREATE_APP_PRE_REGISTRATION_CAMPAIGN', index=46, number=51,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='INCOMPATIBLE_BUDGET_TYPE', index=47, number=52,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_CAMPAIGNERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.errors.CampaignErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
