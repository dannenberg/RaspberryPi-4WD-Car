...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/errors/keyword_plan_ad_group_keyword_error.proto',
...
_KEYWORDPLANADGROUPKEYWORDERRORENUM_KEYWORDPLANADGROUPKEYWORDERROR = _descriptor.EnumDescriptor(
  ...
  full_name='google.ads.googleads.v9.errors.KeywordPlanAdGroupKeywordErrorEnum.KeywordPlanAdGroupKeywordError',
  filename=None,
  file=DESCRIPTOR,
  create_key=_descriptor._internal_create_key,
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      create_key=_descriptor._internal_create_key),
    _descriptor.EnumValueDescriptor(
      name='NEW_BMM_KEYWORDS_NOT_ALLOWED', index=9, number=9,
      serialized_options=None,
      type=None,
      create_key=_descriptor._internal_create_key),
  ],
...
_KEYWORDPLANADGROUPKEYWORDERRORENUM = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.errors.KeywordPlanAdGroupKeywordErrorEnum',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
KeywordPlanAdGroupKeywordErrorEnum = _reflection.GeneratedProtocolMessageType('KeywordPlanAdGroupKeywordErrorEnum', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.errors.keyword_plan_ad_group_keyword_error_pb2'
