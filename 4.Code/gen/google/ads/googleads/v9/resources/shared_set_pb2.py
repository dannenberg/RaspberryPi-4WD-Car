...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/resources/shared_set.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_shared__set__status__pb2.DESCRIPTOR,google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_shared__set__type__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_SHAREDSET = _descriptor.Descriptor(
  name='SharedSet',
  full_name='google.ads.googleads.v9.resources.SharedSet',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.resources.SharedSet.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v9.resources.SharedSet.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='type', full_name='google.ads.googleads.v9.resources.SharedSet.type', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v9.resources.SharedSet.name', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v9.resources.SharedSet.status', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='member_count', full_name='google.ads.googleads.v9.resources.SharedSet.member_count', index=5,
      number=10, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\003', json_name='memberCount', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='reference_count', full_name='google.ads.googleads.v9.resources.SharedSet.reference_count', index=6,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v9.resources.SharedSet._id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_name', full_name='google.ads.googleads.v9.resources.SharedSet._name',
      index=1, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_member_count', full_name='google.ads.googleads.v9.resources.SharedSet._member_count',
      index=2, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_reference_count', full_name='google.ads.googleads.v9.resources.SharedSet._reference_count',
...
_SHAREDSET.fields_by_name['type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_shared__set__type__pb2._SHAREDSETTYPEENUM_SHAREDSETTYPE
_SHAREDSET.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_shared__set__status__pb2._SHAREDSETSTATUSENUM_SHAREDSETSTATUS
