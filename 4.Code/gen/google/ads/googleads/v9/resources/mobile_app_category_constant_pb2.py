...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/resources/mobile_app_category_constant.proto',
...
_MOBILEAPPCATEGORYCONSTANT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.resources.MobileAppCategoryConstant',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.resources.MobileAppCategoryConstant.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v9.resources.MobileAppCategoryConstant.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v9.resources.MobileAppCategoryConstant.name', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_id', full_name='google.ads.googleads.v9.resources.MobileAppCategoryConstant._id',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_name', full_name='google.ads.googleads.v9.resources.MobileAppCategoryConstant._name',
...
MobileAppCategoryConstant = _reflection.GeneratedProtocolMessageType('MobileAppCategoryConstant', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.resources.mobile_app_category_constant_pb2'
