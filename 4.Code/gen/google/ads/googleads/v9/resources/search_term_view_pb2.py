...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/resources/search_term_view.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_search__term__targeting__status__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,])
...
_SEARCHTERMVIEW = _descriptor.Descriptor(
  name='SearchTermView',
  full_name='google.ads.googleads.v9.resources.SearchTermView',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.resources.SearchTermView.resource_name', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='search_term', full_name='google.ads.googleads.v9.resources.SearchTermView.search_term', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='ad_group', full_name='google.ads.googleads.v9.resources.SearchTermView.ad_group', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='status', full_name='google.ads.googleads.v9.resources.SearchTermView.status', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='_search_term', full_name='google.ads.googleads.v9.resources.SearchTermView._search_term',
      index=0, containing_type=None,
      create_key=_descriptor._internal_create_key,
    fields=[]),
    _descriptor.OneofDescriptor(
      name='_ad_group', full_name='google.ads.googleads.v9.resources.SearchTermView._ad_group',
...
_SEARCHTERMVIEW.fields_by_name['status'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_search__term__targeting__status__pb2._SEARCHTERMTARGETINGSTATUSENUM_SEARCHTERMTARGETINGSTATUS
