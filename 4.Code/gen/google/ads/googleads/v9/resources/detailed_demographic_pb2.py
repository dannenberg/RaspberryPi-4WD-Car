...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/resources/detailed_demographic.proto',
...
_DETAILEDDEMOGRAPHIC = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.resources.DetailedDemographic',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.resources.DetailedDemographic.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\003\372A.\n,googleads.googleapis.com/DetailedDemographic', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='id', full_name='google.ads.googleads.v9.resources.DetailedDemographic.id', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='google.ads.googleads.v9.resources.DetailedDemographic.name', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='parent', full_name='google.ads.googleads.v9.resources.DetailedDemographic.parent', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\003\372A.\n,googleads.googleapis.com/DetailedDemographic', json_name='parent', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='launched_to_all', full_name='google.ads.googleads.v9.resources.DetailedDemographic.launched_to_all', index=4,
    ...
    _descriptor.FieldDescriptor(
      name='availabilities', full_name='google.ads.googleads.v9.resources.DetailedDemographic.availabilities', index=5,
...
_DETAILEDDEMOGRAPHIC.fields_by_name['availabilities'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_common_dot_criterion__category__availability__pb2._CRITERIONCATEGORYAVAILABILITY
