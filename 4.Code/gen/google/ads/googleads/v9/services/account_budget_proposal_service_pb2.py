...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/account_budget_proposal_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_account__budget__proposal__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,])
...
_GETACCOUNTBUDGETPROPOSALREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetAccountBudgetProposalRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetAccountBudgetProposalRequest.resource_name', index=0,
...
_MUTATEACCOUNTBUDGETPROPOSALREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalRequest.operation', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalRequest.validate_only', index=2,
...
_ACCOUNTBUDGETPROPOSALOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.AccountBudgetProposalOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v9.services.AccountBudgetProposalOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.AccountBudgetProposalOperation.create', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.AccountBudgetProposalOperation.remove', index=2,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.AccountBudgetProposalOperation.operation',
...
_MUTATEACCOUNTBUDGETPROPOSALRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='result', full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalResponse.result', index=0,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEACCOUNTBUDGETPROPOSALRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateAccountBudgetProposalResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACCOUNTBUDGETPROPOSALOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_account__budget__proposal__pb2._ACCOUNTBUDGETPROPOSAL
...
_ACCOUNTBUDGETPROPOSALSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.AccountBudgetProposalService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.AccountBudgetProposalService.GetAccountBudgetProposal',
    index=0,
    containing_service=None,
    input_type=_GETACCOUNTBUDGETPROPOSALREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_account__budget__proposal__pb2._ACCOUNTBUDGETPROPOSAL,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002:\0228/v9/{resource_name=customers/*/accountBudgetProposals/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateAccountBudgetProposal',
    full_name='google.ads.googleads.v9.services.AccountBudgetProposalService.MutateAccountBudgetProposal',
    index=1,
    containing_service=None,
    input_type=_MUTATEACCOUNTBUDGETPROPOSALREQUEST,
    output_type=_MUTATEACCOUNTBUDGETPROPOSALRESPONSE,
    serialized_options=b'\332A\025customer_id,operation\202\323\344\223\002@\";/v9/customers/{customer_id=*}/accountBudgetProposals:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
