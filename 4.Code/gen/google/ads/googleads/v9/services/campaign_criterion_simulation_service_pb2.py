...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/campaign_criterion_simulation_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__criterion__simulation__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,])
...
_GETCAMPAIGNCRITERIONSIMULATIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetCampaignCriterionSimulationRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetCampaignCriterionSimulationRequest.resource_name', index=0,
...
_CAMPAIGNCRITERIONSIMULATIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.CampaignCriterionSimulationService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.CampaignCriterionSimulationService.GetCampaignCriterionSimulation',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNCRITERIONSIMULATIONREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__criterion__simulation__pb2._CAMPAIGNCRITERIONSIMULATION,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002@\022>/v9/{resource_name=customers/*/campaignCriterionSimulations/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
