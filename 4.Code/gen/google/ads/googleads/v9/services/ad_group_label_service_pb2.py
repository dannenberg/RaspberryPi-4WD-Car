...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/ad_group_label_service.proto',
...
_GETADGROUPLABELREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetAdGroupLabelRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetAdGroupLabelRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A\'\n%googleads.googleapis.com/AdGroupLabel', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MUTATEADGROUPLABELSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsRequest.validate_only', index=3,
...
_ADGROUPLABELOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.AdGroupLabelOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.AdGroupLabelOperation.create', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.AdGroupLabelOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.AdGroupLabelOperation.operation',
...
_MUTATEADGROUPLABELSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADGROUPLABELRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAdGroupLabelResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateAdGroupLabelResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPLABELOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_ad__group__label__pb2._ADGROUPLABEL
...
GetAdGroupLabelRequest = _reflection.GeneratedProtocolMessageType('GetAdGroupLabelRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.ad_group_label_service_pb2'
...
_ADGROUPLABELSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.AdGroupLabelService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.AdGroupLabelService.GetAdGroupLabel',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPLABELREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_ad__group__label__pb2._ADGROUPLABEL,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0021\022//v9/{resource_name=customers/*/adGroupLabels/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdGroupLabels',
    full_name='google.ads.googleads.v9.services.AdGroupLabelService.MutateAdGroupLabels',
    index=1,
    containing_service=None,
    input_type=_MUTATEADGROUPLABELSREQUEST,
    output_type=_MUTATEADGROUPLABELSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\0027\"2/v9/customers/{customer_id=*}/adGroupLabels:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
