...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/operating_system_version_constant_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_operating__system__version__constant__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,])
...
_GETOPERATINGSYSTEMVERSIONCONSTANTREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetOperatingSystemVersionConstantRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetOperatingSystemVersionConstantRequest.resource_name', index=0,
...
_OPERATINGSYSTEMVERSIONCONSTANTSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.OperatingSystemVersionConstantService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.OperatingSystemVersionConstantService.GetOperatingSystemVersionConstant',
    index=0,
    containing_service=None,
    input_type=_GETOPERATINGSYSTEMVERSIONCONSTANTREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_operating__system__version__constant__pb2._OPERATINGSYSTEMVERSIONCONSTANT,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0027\0225/v9/{resource_name=operatingSystemVersionConstants/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
