...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/remarketing_action_service.proto',
...
_GETREMARKETINGACTIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetRemarketingActionRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetRemarketingActionRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A,\n*googleads.googleapis.com/RemarketingAction', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MUTATEREMARKETINGACTIONSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateRemarketingActionsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateRemarketingActionsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateRemarketingActionsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateRemarketingActionsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateRemarketingActionsRequest.validate_only', index=3,
...
_REMARKETINGACTIONOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.RemarketingActionOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v9.services.RemarketingActionOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.RemarketingActionOperation.create', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v9.services.RemarketingActionOperation.update', index=2,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.RemarketingActionOperation.operation',
...
_MUTATEREMARKETINGACTIONSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateRemarketingActionsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateRemarketingActionsResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateRemarketingActionsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEREMARKETINGACTIONRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateRemarketingActionResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateRemarketingActionResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_REMARKETINGACTIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_remarketing__action__pb2._REMARKETINGACTION
_REMARKETINGACTIONOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_remarketing__action__pb2._REMARKETINGACTION
...
GetRemarketingActionRequest = _reflection.GeneratedProtocolMessageType('GetRemarketingActionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.remarketing_action_service_pb2'
...
_REMARKETINGACTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.RemarketingActionService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.RemarketingActionService.GetRemarketingAction',
    index=0,
    containing_service=None,
    input_type=_GETREMARKETINGACTIONREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_remarketing__action__pb2._REMARKETINGACTION,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0026\0224/v9/{resource_name=customers/*/remarketingActions/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateRemarketingActions',
    full_name='google.ads.googleads.v9.services.RemarketingActionService.MutateRemarketingActions',
    index=1,
    containing_service=None,
    input_type=_MUTATEREMARKETINGACTIONSREQUEST,
    output_type=_MUTATEREMARKETINGACTIONSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002<\"7/v9/customers/{customer_id=*}/remarketingActions:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
