...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/invoice_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_month__of__year__pb2.DESCRIPTOR,google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_invoice__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,])
...
_LISTINVOICESREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.ListInvoicesRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.ListInvoicesRequest.customer_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='billing_setup', full_name='google.ads.googleads.v9.services.ListInvoicesRequest.billing_setup', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002', json_name='billingSetup', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='issue_year', full_name='google.ads.googleads.v9.services.ListInvoicesRequest.issue_year', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002', json_name='issueYear', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='issue_month', full_name='google.ads.googleads.v9.services.ListInvoicesRequest.issue_month', index=3,
      number=4, type=14, cpp_type=8, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002', json_name='issueMonth', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LISTINVOICESRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.ListInvoicesResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='invoices', full_name='google.ads.googleads.v9.services.ListInvoicesResponse.invoices', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='invoices', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_LISTINVOICESREQUEST.fields_by_name['issue_month'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_month__of__year__pb2._MONTHOFYEARENUM_MONTHOFYEAR
_LISTINVOICESRESPONSE.fields_by_name['invoices'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_invoice__pb2._INVOICE
...
_INVOICESERVICE = _descriptor.ServiceDescriptor(
  name='InvoiceService',
  full_name='google.ads.googleads.v9.services.InvoiceService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='ListInvoices',
    full_name='google.ads.googleads.v9.services.InvoiceService.ListInvoices',
    index=0,
    containing_service=None,
    input_type=_LISTINVOICESREQUEST,
    output_type=_LISTINVOICESRESPONSE,
    serialized_options=b'\332A0customer_id,billing_setup,issue_year,issue_month\202\323\344\223\002(\022&/v9/customers/{customer_id=*}/invoices',
    create_key=_descriptor._internal_create_key,
  ),
])
