...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/customer_customizer_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2.DESCRIPTOR,google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_customer__customizer__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])




_MUTATECUSTOMERCUSTOMIZERSREQUEST = _descriptor.Descriptor(
  name='MutateCustomerCustomizersRequest',
  full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersRequest.customer_id', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersRequest.validate_only', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersRequest.response_content_type', index=4,
...
_CUSTOMERCUSTOMIZEROPERATION = _descriptor.Descriptor(
  name='CustomerCustomizerOperation',
  full_name='google.ads.googleads.v9.services.CustomerCustomizerOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.CustomerCustomizerOperation.create', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.CustomerCustomizerOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.CustomerCustomizerOperation.operation',
...
_MUTATECUSTOMERCUSTOMIZERSRESPONSE = _descriptor.Descriptor(
  name='MutateCustomerCustomizersResponse',
  full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersResponse.results', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizersResponse.partial_failure_error', index=1,
...
_MUTATECUSTOMERCUSTOMIZERRESULT = _descriptor.Descriptor(
  name='MutateCustomerCustomizerResult',
  full_name='google.ads.googleads.v9.services.MutateCustomerCustomizerResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizerResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='customer_customizer', full_name='google.ads.googleads.v9.services.MutateCustomerCustomizerResult.customer_customizer', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECUSTOMERCUSTOMIZERSREQUEST.fields_by_name['operations'].message_type = _CUSTOMERCUSTOMIZEROPERATION
_MUTATECUSTOMERCUSTOMIZERSREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
_CUSTOMERCUSTOMIZEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_customer__customizer__pb2._CUSTOMERCUSTOMIZER
_CUSTOMERCUSTOMIZEROPERATION.oneofs_by_name['operation'].fields.append(
  _CUSTOMERCUSTOMIZEROPERATION.fields_by_name['create'])
_CUSTOMERCUSTOMIZEROPERATION.fields_by_name['create'].containing_oneof = _CUSTOMERCUSTOMIZEROPERATION.oneofs_by_name['operation']
_CUSTOMERCUSTOMIZEROPERATION.oneofs_by_name['operation'].fields.append(
  _CUSTOMERCUSTOMIZEROPERATION.fields_by_name['remove'])
_CUSTOMERCUSTOMIZEROPERATION.fields_by_name['remove'].containing_oneof = _CUSTOMERCUSTOMIZEROPERATION.oneofs_by_name['operation']
_MUTATECUSTOMERCUSTOMIZERSRESPONSE.fields_by_name['results'].message_type = _MUTATECUSTOMERCUSTOMIZERRESULT
_MUTATECUSTOMERCUSTOMIZERSRESPONSE.fields_by_name['partial_failure_error'].message_type = google_dot_rpc_dot_status__pb2._STATUS
_MUTATECUSTOMERCUSTOMIZERRESULT.fields_by_name['customer_customizer'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_customer__customizer__pb2._CUSTOMERCUSTOMIZER
DESCRIPTOR.message_types_by_name['MutateCustomerCustomizersRequest'] = _MUTATECUSTOMERCUSTOMIZERSREQUEST
DESCRIPTOR.message_types_by_name['CustomerCustomizerOperation'] = _CUSTOMERCUSTOMIZEROPERATION
DESCRIPTOR.message_types_by_name['MutateCustomerCustomizersResponse'] = _MUTATECUSTOMERCUSTOMIZERSRESPONSE
DESCRIPTOR.message_types_by_name['MutateCustomerCustomizerResult'] = _MUTATECUSTOMERCUSTOMIZERRESULT
...
_CUSTOMERCUSTOMIZERSERVICE = _descriptor.ServiceDescriptor(
  name='CustomerCustomizerService',
  full_name='google.ads.googleads.v9.services.CustomerCustomizerService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.CustomerCustomizerService.MutateCustomerCustomizers',
    index=0,
    containing_service=None,
    input_type=_MUTATECUSTOMERCUSTOMIZERSREQUEST,
    output_type=_MUTATECUSTOMERCUSTOMIZERSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002=\"8/v9/customers/{customer_id=*}/CustomerCustomizers:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
_sym_db.RegisterServiceDescriptor(_CUSTOMERCUSTOMIZERSERVICE)

DESCRIPTOR.services_by_name['CustomerCustomizerService'] = _CUSTOMERCUSTOMIZERSERVICE
