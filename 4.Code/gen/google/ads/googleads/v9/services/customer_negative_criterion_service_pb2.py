...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/customer_negative_criterion_service.proto',
...
_GETCUSTOMERNEGATIVECRITERIONREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetCustomerNegativeCriterionRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetCustomerNegativeCriterionRequest.resource_name', index=0,
...
_MUTATECUSTOMERNEGATIVECRITERIAREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest.validate_only', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaRequest.response_content_type', index=4,
...
_CUSTOMERNEGATIVECRITERIONOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionOperation.create', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionOperation.operation',
...
_MUTATECUSTOMERNEGATIVECRITERIARESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECUSTOMERNEGATIVECRITERIARESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='customer_negative_criterion', full_name='google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResult.customer_negative_criterion', index=1,
...
_MUTATECUSTOMERNEGATIVECRITERIAREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
_CUSTOMERNEGATIVECRITERIONOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION
...
_MUTATECUSTOMERNEGATIVECRITERIARESULT.fields_by_name['customer_negative_criterion'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION
...
GetCustomerNegativeCriterionRequest = _reflection.GeneratedProtocolMessageType('GetCustomerNegativeCriterionRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.customer_negative_criterion_service_pb2'
...
_CUSTOMERNEGATIVECRITERIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionService.GetCustomerNegativeCriterion',
    index=0,
    containing_service=None,
    input_type=_GETCUSTOMERNEGATIVECRITERIONREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_customer__negative__criterion__pb2._CUSTOMERNEGATIVECRITERION,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002<\022:/v9/{resource_name=customers/*/customerNegativeCriteria/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCustomerNegativeCriteria',
    full_name='google.ads.googleads.v9.services.CustomerNegativeCriterionService.MutateCustomerNegativeCriteria',
    index=1,
    containing_service=None,
    input_type=_MUTATECUSTOMERNEGATIVECRITERIAREQUEST,
    output_type=_MUTATECUSTOMERNEGATIVECRITERIARESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002B\"=/v9/customers/{customer_id=*}/customerNegativeCriteria:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
