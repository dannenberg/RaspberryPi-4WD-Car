...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/feed_service.proto',
...
_GETFEEDREQUEST = _descriptor.Descriptor(
  name='GetFeedRequest',
  full_name='google.ads.googleads.v9.services.GetFeedRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetFeedRequest.resource_name', index=0,
...
_MUTATEFEEDSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateFeedsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateFeedsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateFeedsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateFeedsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateFeedsRequest.validate_only', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v9.services.MutateFeedsRequest.response_content_type', index=4,
...
_FEEDOPERATION = _descriptor.Descriptor(
  name='FeedOperation',
  full_name='google.ads.googleads.v9.services.FeedOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v9.services.FeedOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.FeedOperation.create', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v9.services.FeedOperation.update', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.FeedOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.FeedOperation.operation',
...
_MUTATEFEEDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateFeedsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateFeedsResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateFeedsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEFEEDRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateFeedResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateFeedResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='feed', full_name='google.ads.googleads.v9.services.MutateFeedResult.feed', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEFEEDSREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
_FEEDOPERATION.fields_by_name['update_mask'].message_type = google_dot_protobuf_dot_field__mask__pb2._FIELDMASK
_FEEDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_feed__pb2._FEED
_FEEDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_feed__pb2._FEED
...
_MUTATEFEEDRESULT.fields_by_name['feed'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_feed__pb2._FEED
...
_FEEDSERVICE = _descriptor.ServiceDescriptor(
  name='FeedService',
  full_name='google.ads.googleads.v9.services.FeedService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    name='GetFeed',
    full_name='google.ads.googleads.v9.services.FeedService.GetFeed',
    index=0,
    containing_service=None,
    input_type=_GETFEEDREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_feed__pb2._FEED,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002)\022\'/v9/{resource_name=customers/*/feeds/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateFeeds',
    full_name='google.ads.googleads.v9.services.FeedService.MutateFeeds',
    index=1,
    containing_service=None,
    input_type=_MUTATEFEEDSREQUEST,
    output_type=_MUTATEFEEDSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002/\"*/v9/customers/{customer_id=*}/feeds:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
