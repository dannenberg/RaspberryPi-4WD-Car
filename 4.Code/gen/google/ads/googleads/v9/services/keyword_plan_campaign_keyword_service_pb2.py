...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/keyword_plan_campaign_keyword_service.proto',
...
_GETKEYWORDPLANCAMPAIGNKEYWORDREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetKeywordPlanCampaignKeywordRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetKeywordPlanCampaignKeywordRequest.resource_name', index=0,
...
_MUTATEKEYWORDPLANCAMPAIGNKEYWORDSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsRequest.validate_only', index=3,
...
_KEYWORDPLANCAMPAIGNKEYWORDOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordOperation.create', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordOperation.update', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordOperation.operation',
...
_MUTATEKEYWORDPLANCAMPAIGNKEYWORDSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEKEYWORDPLANCAMPAIGNKEYWORDRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateKeywordPlanCampaignKeywordResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_KEYWORDPLANCAMPAIGNKEYWORDOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_keyword__plan__campaign__keyword__pb2._KEYWORDPLANCAMPAIGNKEYWORD
_KEYWORDPLANCAMPAIGNKEYWORDOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_keyword__plan__campaign__keyword__pb2._KEYWORDPLANCAMPAIGNKEYWORD
...
GetKeywordPlanCampaignKeywordRequest = _reflection.GeneratedProtocolMessageType('GetKeywordPlanCampaignKeywordRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.keyword_plan_campaign_keyword_service_pb2'
...
_KEYWORDPLANCAMPAIGNKEYWORDSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService.GetKeywordPlanCampaignKeyword',
    index=0,
    containing_service=None,
    input_type=_GETKEYWORDPLANCAMPAIGNKEYWORDREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_keyword__plan__campaign__keyword__pb2._KEYWORDPLANCAMPAIGNKEYWORD,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002?\022=/v9/{resource_name=customers/*/keywordPlanCampaignKeywords/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateKeywordPlanCampaignKeywords',
    full_name='google.ads.googleads.v9.services.KeywordPlanCampaignKeywordService.MutateKeywordPlanCampaignKeywords',
    index=1,
    containing_service=None,
    input_type=_MUTATEKEYWORDPLANCAMPAIGNKEYWORDSREQUEST,
    output_type=_MUTATEKEYWORDPLANCAMPAIGNKEYWORDSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002E\"@/v9/customers/{customer_id=*}/keywordPlanCampaignKeywords:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
