...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/income_range_view_service.proto',
...
_GETINCOMERANGEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetIncomeRangeViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetIncomeRangeViewRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A*\n(googleads.googleapis.com/IncomeRangeView', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
GetIncomeRangeViewRequest = _reflection.GeneratedProtocolMessageType('GetIncomeRangeViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.income_range_view_service_pb2'
...
_INCOMERANGEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.IncomeRangeViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.IncomeRangeViewService.GetIncomeRangeView',
    index=0,
    containing_service=None,
    input_type=_GETINCOMERANGEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_income__range__view__pb2._INCOMERANGEVIEW,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0024\0222/v9/{resource_name=customers/*/incomeRangeViews/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
