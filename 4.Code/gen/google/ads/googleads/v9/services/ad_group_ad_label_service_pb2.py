...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/ad_group_ad_label_service.proto',
...
_GETADGROUPADLABELREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetAdGroupAdLabelRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetAdGroupAdLabelRequest.resource_name', index=0,
...
_MUTATEADGROUPADLABELSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsRequest.validate_only', index=3,
...
_ADGROUPADLABELOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.AdGroupAdLabelOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.AdGroupAdLabelOperation.create', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.AdGroupAdLabelOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.AdGroupAdLabelOperation.operation',
...
_MUTATEADGROUPADLABELSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATEADGROUPADLABELRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateAdGroupAdLabelResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ADGROUPADLABELOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_ad__group__ad__label__pb2._ADGROUPADLABEL
...
_ADGROUPADLABELSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.AdGroupAdLabelService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.AdGroupAdLabelService.GetAdGroupAdLabel',
    index=0,
    containing_service=None,
    input_type=_GETADGROUPADLABELREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_ad__group__ad__label__pb2._ADGROUPADLABEL,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0023\0221/v9/{resource_name=customers/*/adGroupAdLabels/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateAdGroupAdLabels',
    full_name='google.ads.googleads.v9.services.AdGroupAdLabelService.MutateAdGroupAdLabels',
    index=1,
    containing_service=None,
    input_type=_MUTATEADGROUPADLABELSREQUEST,
    output_type=_MUTATEADGROUPADLABELSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\0029\"4/v9/customers/{customer_id=*}/adGroupAdLabels:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
