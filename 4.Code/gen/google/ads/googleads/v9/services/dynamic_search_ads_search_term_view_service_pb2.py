...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/dynamic_search_ads_search_term_view_service.proto',
...
_GETDYNAMICSEARCHADSSEARCHTERMVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetDynamicSearchAdsSearchTermViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetDynamicSearchAdsSearchTermViewRequest.resource_name', index=0,
...
_DYNAMICSEARCHADSSEARCHTERMVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.DynamicSearchAdsSearchTermViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.DynamicSearchAdsSearchTermViewService.GetDynamicSearchAdsSearchTermView',
    index=0,
    containing_service=None,
    input_type=_GETDYNAMICSEARCHADSSEARCHTERMVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_dynamic__search__ads__search__term__view__pb2._DYNAMICSEARCHADSSEARCHTERMVIEW,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002C\022A/v9/{resource_name=customers/*/dynamicSearchAdsSearchTermViews/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
