...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/conversion_value_rule_set_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2.DESCRIPTOR,google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_conversion__value__rule__set__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,google_dot_protobuf_dot_field__mask__pb2.DESCRIPTOR,google_dot_rpc_dot_status__pb2.DESCRIPTOR,])
...
_GETCONVERSIONVALUERULESETREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetConversionValueRuleSetRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetConversionValueRuleSetRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A1\n/googleads.googleapis.com/ConversionValueRuleSet', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MUTATECONVERSIONVALUERULESETSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest.validate_only', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsRequest.response_content_type', index=4,
...
_CONVERSIONVALUERULESETOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.ConversionValueRuleSetOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v9.services.ConversionValueRuleSetOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.ConversionValueRuleSetOperation.create', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v9.services.ConversionValueRuleSetOperation.update', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.ConversionValueRuleSetOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.ConversionValueRuleSetOperation.operation',
...
_MUTATECONVERSIONVALUERULESETSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsResponse.results', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetsResponse.partial_failure_error', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECONVERSIONVALUERULESETRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='conversion_value_rule_set', full_name='google.ads.googleads.v9.services.MutateConversionValueRuleSetResult.conversion_value_rule_set', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECONVERSIONVALUERULESETSREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
...
_CONVERSIONVALUERULESETOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_conversion__value__rule__set__pb2._CONVERSIONVALUERULESET
_CONVERSIONVALUERULESETOPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_conversion__value__rule__set__pb2._CONVERSIONVALUERULESET
...
_MUTATECONVERSIONVALUERULESETRESULT.fields_by_name['conversion_value_rule_set'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_conversion__value__rule__set__pb2._CONVERSIONVALUERULESET
...
_CONVERSIONVALUERULESETSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.ConversionValueRuleSetService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.ConversionValueRuleSetService.GetConversionValueRuleSet',
    index=0,
    containing_service=None,
    input_type=_GETCONVERSIONVALUERULESETREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_conversion__value__rule__set__pb2._CONVERSIONVALUERULESET,
    serialized_options=b'\332A\rresource_name\202\323\344\223\002;\0229/v9/{resource_name=customers/*/conversionValueRuleSets/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateConversionValueRuleSets',
    full_name='google.ads.googleads.v9.services.ConversionValueRuleSetService.MutateConversionValueRuleSets',
    index=1,
    containing_service=None,
    input_type=_MUTATECONVERSIONVALUERULESETSREQUEST,
    output_type=_MUTATECONVERSIONVALUERULESETSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002A\"</v9/customers/{customer_id=*}/conversionValueRuleSets:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
