...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/campaign_label_service.proto',
...
_GETCAMPAIGNLABELREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetCampaignLabelRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetCampaignLabelRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A(\n&googleads.googleapis.com/CampaignLabel', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MUTATECAMPAIGNLABELSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCampaignLabelsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateCampaignLabelsRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateCampaignLabelsRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateCampaignLabelsRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateCampaignLabelsRequest.validate_only', index=3,
...
_CAMPAIGNLABELOPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.CampaignLabelOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.CampaignLabelOperation.create', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.CampaignLabelOperation.remove', index=1,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.CampaignLabelOperation.operation',
...
_MUTATECAMPAIGNLABELSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCampaignLabelsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateCampaignLabelsResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateCampaignLabelsResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECAMPAIGNLABELRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCampaignLabelResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateCampaignLabelResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CAMPAIGNLABELOPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__label__pb2._CAMPAIGNLABEL
...
_CAMPAIGNLABELSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.CampaignLabelService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.CampaignLabelService.GetCampaignLabel',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNLABELREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__label__pb2._CAMPAIGNLABEL,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0022\0220/v9/{resource_name=customers/*/campaignLabels/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCampaignLabels',
    full_name='google.ads.googleads.v9.services.CampaignLabelService.MutateCampaignLabels',
    index=1,
    containing_service=None,
    input_type=_MUTATECAMPAIGNLABELSREQUEST,
    output_type=_MUTATECAMPAIGNLABELSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\0028\"3/v9/customers/{customer_id=*}/campaignLabels:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
