...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/distance_view_service.proto',
  ...
  ,
  dependencies=[google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_distance__view__pb2.DESCRIPTOR,google_dot_api_dot_annotations__pb2.DESCRIPTOR,google_dot_api_dot_client__pb2.DESCRIPTOR,google_dot_api_dot_field__behavior__pb2.DESCRIPTOR,google_dot_api_dot_resource__pb2.DESCRIPTOR,])
...
_GETDISTANCEVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetDistanceViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetDistanceViewRequest.resource_name', index=0,
...
_DISTANCEVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.DistanceViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.DistanceViewService.GetDistanceView',
    index=0,
    containing_service=None,
    input_type=_GETDISTANCEVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_distance__view__pb2._DISTANCEVIEW,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0021\022//v9/{resource_name=customers/*/distanceViews/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
