...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/geographic_view_service.proto',
...
_GETGEOGRAPHICVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetGeographicViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetGeographicViewRequest.resource_name', index=0,
...
GetGeographicViewRequest = _reflection.GeneratedProtocolMessageType('GetGeographicViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.geographic_view_service_pb2'
...
_GEOGRAPHICVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.GeographicViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.GeographicViewService.GetGeographicView',
    index=0,
    containing_service=None,
    input_type=_GETGEOGRAPHICVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_geographic__view__pb2._GEOGRAPHICVIEW,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0023\0221/v9/{resource_name=customers/*/geographicViews/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
