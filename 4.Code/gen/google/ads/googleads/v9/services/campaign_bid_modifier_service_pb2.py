...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/campaign_bid_modifier_service.proto',
...
_GETCAMPAIGNBIDMODIFIERREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetCampaignBidModifierRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetCampaignBidModifierRequest.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\342A\001\002\372A.\n,googleads.googleapis.com/CampaignBidModifier', json_name='resourceName', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
_MUTATECAMPAIGNBIDMODIFIERSREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='customer_id', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.customer_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='operations', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.operations', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='partial_failure', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.partial_failure', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='validate_only', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.validate_only', index=3,
    ...
    _descriptor.FieldDescriptor(
      name='response_content_type', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersRequest.response_content_type', index=4,
...
_CAMPAIGNBIDMODIFIEROPERATION = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.CampaignBidModifierOperation',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='update_mask', full_name='google.ads.googleads.v9.services.CampaignBidModifierOperation.update_mask', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='create', full_name='google.ads.googleads.v9.services.CampaignBidModifierOperation.create', index=1,
    ...
    _descriptor.FieldDescriptor(
      name='update', full_name='google.ads.googleads.v9.services.CampaignBidModifierOperation.update', index=2,
    ...
    _descriptor.FieldDescriptor(
      name='remove', full_name='google.ads.googleads.v9.services.CampaignBidModifierOperation.remove', index=3,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='operation', full_name='google.ads.googleads.v9.services.CampaignBidModifierOperation.operation',
...
_MUTATECAMPAIGNBIDMODIFIERSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='partial_failure_error', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse.partial_failure_error', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='results', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifiersResponse.results', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECAMPAIGNBIDMODIFIERRESULT = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.MutateCampaignBidModifierResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifierResult.resource_name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='campaign_bid_modifier', full_name='google.ads.googleads.v9.services.MutateCampaignBidModifierResult.campaign_bid_modifier', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_MUTATECAMPAIGNBIDMODIFIERSREQUEST.fields_by_name['response_content_type'].enum_type = google_dot_ads_dot_googleads_dot_v9_dot_enums_dot_response__content__type__pb2._RESPONSECONTENTTYPEENUM_RESPONSECONTENTTYPE
...
_CAMPAIGNBIDMODIFIEROPERATION.fields_by_name['create'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
_CAMPAIGNBIDMODIFIEROPERATION.fields_by_name['update'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
...
_MUTATECAMPAIGNBIDMODIFIERRESULT.fields_by_name['campaign_bid_modifier'].message_type = google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER
...
_CAMPAIGNBIDMODIFIERSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.CampaignBidModifierService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.CampaignBidModifierService.GetCampaignBidModifier',
    index=0,
    containing_service=None,
    input_type=_GETCAMPAIGNBIDMODIFIERREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_campaign__bid__modifier__pb2._CAMPAIGNBIDMODIFIER,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0028\0226/v9/{resource_name=customers/*/campaignBidModifiers/*}',
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='MutateCampaignBidModifiers',
    full_name='google.ads.googleads.v9.services.CampaignBidModifierService.MutateCampaignBidModifiers',
    index=1,
    containing_service=None,
    input_type=_MUTATECAMPAIGNBIDMODIFIERSREQUEST,
    output_type=_MUTATECAMPAIGNBIDMODIFIERSRESPONSE,
    serialized_options=b'\332A\026customer_id,operations\202\323\344\223\002>\"9/v9/customers/{customer_id=*}/campaignBidModifiers:mutate:\001*',
    create_key=_descriptor._internal_create_key,
  ),
])
