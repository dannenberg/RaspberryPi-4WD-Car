...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='google/ads/googleads/v9/services/user_location_view_service.proto',
...
_GETUSERLOCATIONVIEWREQUEST = _descriptor.Descriptor(
  ...
  full_name='google.ads.googleads.v9.services.GetUserLocationViewRequest',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='resource_name', full_name='google.ads.googleads.v9.services.GetUserLocationViewRequest.resource_name', index=0,
...
GetUserLocationViewRequest = _reflection.GeneratedProtocolMessageType('GetUserLocationViewRequest', (_message.Message,), {
  ...
  '__module__' : 'google.ads.googleads.v9.services.user_location_view_service_pb2'
...
_USERLOCATIONVIEWSERVICE = _descriptor.ServiceDescriptor(
  ...
  full_name='google.ads.googleads.v9.services.UserLocationViewService',
  file=DESCRIPTOR,
  index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='google.ads.googleads.v9.services.UserLocationViewService.GetUserLocationView',
    index=0,
    containing_service=None,
    input_type=_GETUSERLOCATIONVIEWREQUEST,
    output_type=google_dot_ads_dot_googleads_dot_v9_dot_resources_dot_user__location__view__pb2._USERLOCATIONVIEW,
    serialized_options=b'\332A\rresource_name\202\323\344\223\0025\0223/v9/{resource_name=customers/*/userLocationViews/*}',
    create_key=_descriptor._internal_create_key,
  ),
])
